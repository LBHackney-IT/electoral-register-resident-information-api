...
using ElectoralRegisterResidentInformationApi.Versioning;
...
namespace ElectoralRegisterResidentInformationApi
{
    public class Startup
    {
        ...
        private const string ApiName = "Electoral Register Resident Information API";
